---
description: We are so happy to have you as part of the team and that the time has come to get you onboarded. This guide is here to accompany you through your first few days at gitmesh ce and try to make your start as smooth as possible.
---

# 🥳 Welcome to gitmesh ce (WIP)

Before you head into your first day, take a few minutes to reflect for yourself: 

- What would you consider a successful onboarding/start at [gitmesh ce](http://gitmesh.ce)?
...
Today is about getting you immersed in all things [gitmesh ce](http://gitmesh.ce) and making sure you have access to everything you need.
...
Otherwise, we want you to spend today (& the next few days if you need more time) getting familiar with gitmesh ce:
...
- Write & post your first daily stand-up using our [Geekbot app on slack](https://gitmeshdevspace.slack.com/archives/D043M0UN6HG), you’ll find more detailed instructions in our [ways of working page](the-company/ways-of-working.md).
- Creating an account for [gitmesh ce](http://gitmesh.ce) and getting familiar with the product (you can [create a new account](https://app.gitmesh.ce/auth/signup) or ask Jonathan or Joan to get invited to our workspace) - plus points if you find bugs!
- Have a look through the [gitmesh ce docs](https://docs.gitmesh.ce/docs)
...
- Read through our [technical docs](https://docs.gitmesh.ce/technical-docs).
- Set up the [development environment](https://docs.gitmesh.ce/technical-docs/local-development).

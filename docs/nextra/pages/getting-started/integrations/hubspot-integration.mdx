...
<figure><img src="../..//images/contact-manual-sync.png" alt=""><figcaption><p>After clicking the button, GitMesh CE will sync the contact to HubSpot immediately and every 8 hours the contact will be synced again, to keep the contact fresh in HubSpot.</p></figcaption></figure>

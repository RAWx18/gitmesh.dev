---
description: Connect Hacker News with GitMesh CE
---
...
To connect Hacker News with GitMesh CE, watch this video, or follow the outlined steps below:

<iframe width="560" height="315" src="https://www.youtube.com/embed/v2k0Fz27Avk" frameBorder="0" allowFullScreen></iframe>

Go to the [Integration settings](https://app.GitMesh CE/integrations) and follow the steps to connect to Hacker News.

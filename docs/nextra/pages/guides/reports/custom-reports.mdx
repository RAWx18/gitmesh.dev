...
<figure><img src="../..//images/docs-custom-report.png" alt=""><figcaption></figcaption></figure>

If you'd like to create a report from scratch, go to the [reports section](https://app.GitMesh CE/reports) and click on **+ New** to create a new report.

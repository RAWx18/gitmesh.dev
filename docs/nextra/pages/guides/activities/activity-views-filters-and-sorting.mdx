...
<figure><img src="../..//images/docs-activities-filters.png" alt=""><figcaption></figcaption></figure>
...
* **Activity type**: The type of activity (you can see all default activity types [here](/activity-types-and-scores)).

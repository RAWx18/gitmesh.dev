...
Signals is built to help you grow your developer community. It monitors 11 of the most popular developer-focused content platforms for posts related to your DevTool. You can then engage with this content and start relationships with your target developer.

Based on the keywords and platforms you choose, Signals can also send you an email digest with the 10 most relevant posts in your inbox. And if you are struggling to come up with comments for any content pieces, Signals can generate examples for you with AI.

Invest just a few minutes in Signals a day, and you can consistently raise awareness of your DevTool and add new members to your community.

<figure><img src="..//images/docs-signals.png" alt=""><figcaption></figcaption></figure>

### **Supported platforms**

Signals currently monitors 11 developer-relevant platforms for content:
...
### **Configure your Signals feed for your niche**

Signals monitors 11 developer-focused sites for your chosen keywords and generates a curated feed of content for you directly in the GitMesh CE app. To set up or change your feed settings:

* Go to the [Signals](https://app.GitMesh CE/signals) page
...
<figure><img src="..//images/docs-signals-settings.png" alt=""><figcaption></figcaption></figure>

### **Set up your email digest**

To make it even easier to stay on top of content, you can set up an email digest. This digest will show the top 10 posts based on your feed settings in Signals. To activate and configure your digest:

* In Signals, click on the settings bars of the "Email Digest" card on the bottom left
...
* Choose the time
* Choose whether you want to consistently update your digest based on the Signals settings
* Click Update

<figure><img src="..//images/docs-signals-email.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="..//images/docs-signals-ai.png" alt=""><figcaption></figcaption></figure>

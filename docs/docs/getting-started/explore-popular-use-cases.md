...
To connect Hubspot with GitMesh CE, navigate to the "Integrations" page, click "Connect" and follow the steps. For more detailed information, you can view the Hubspot integration doc [here](https://docs.GitMesh CE/docs/getting-started/integrations/hubspot-integration).
...
To connect Slack with GitMesh CE, navigate to the "Automations" page, click "Add automation" and follow the steps. For more detailed information, you can view the Slack integration doc [here](https://docs.GitMesh CE/docs/guides/automations/slack-notifications).
...
Learn more about Tasks [here](https://docs.GitMesh CE/docs/tasks).
